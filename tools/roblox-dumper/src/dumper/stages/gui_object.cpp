...
namespace dumper::stages::gui_object {
    ...
    auto dump() -> bool {
        ...
        dumper::g_dumper.add_offset("GuiObject", "Active", *active_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("GuiObject", "AnchorPoint", *anchor_point_offset, "", FieldType::Vector2);
        ...
        dumper::g_dumper.add_offset("GuiObject", "AutomaticSize", *automatic_size_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("GuiObject", "BackgroundColor3", *bg_color_offset, "", FieldType::Color3Float);
        ...
        dumper::g_dumper.add_offset("GuiObject", "BackgroundTransparency", *bg_transparency_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("GuiObject", "BorderColor3", *border_color_offset, "", FieldType::Color3Float);
        ...
        dumper::g_dumper.add_offset("GuiObject", "BorderMode", *border_mode_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("GuiObject", "BorderSizePixel", *border_size_offset, "", FieldType::Int32);
        ...
        dumper::g_dumper.add_offset("GuiObject", "ClipsDescendants", *clips_descendants_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("GuiObject", "GuiState", *gui_state_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("GuiObject", "Interactable", *interactable_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("GuiObject", "LayoutOrder", *layout_order_offset, "", FieldType::Int32);
        ...
        dumper::g_dumper.add_offset("GuiObject", "Rotation", *rotation_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("GuiObject", "Selectable", *selectable_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("GuiObject", "SelectionOrder", *selection_order_offset, "", FieldType::Int32);
        ...
        dumper::g_dumper.add_offset("GuiObject", "SizeConstraint", *size_constraint_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("GuiObject", "Visible", *visible_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("GuiObject", "ZIndex", *zindex_offset, "", FieldType::Int32);
