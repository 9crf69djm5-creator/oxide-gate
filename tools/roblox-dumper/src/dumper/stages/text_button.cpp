...
namespace dumper::stages::text_button {
    ...
    auto dump() -> bool {
        ...
        //     return false;
        // }
        // dumper::g_dumper.add_offset("TextButton", "Font", *font_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextButton", "MaxVisibleGraphemes",
                                    *max_visible_graphemes_offset, "", FieldType::Int32);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextStrokeTransparency",
                                    *text_stroke_transparency_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextButton", "Modal", *modal_offset, "", FieldType::Bool);
