...
namespace dumper::stages::mouse_service {
    ...
    auto dump() -> bool {
        ...
        dumper::g_dumper.add_offset("MouseService", "InputObject", second_input_object, "", FieldType::Pointer);
        dumper::g_dumper.add_offset("InputObject", "MousePosition", 0xD4, "", FieldType::Vector2);

        return true;
    }
} // namespace dumper::stages::mouse_service

REGISTER_STAGE(mouse_service)
