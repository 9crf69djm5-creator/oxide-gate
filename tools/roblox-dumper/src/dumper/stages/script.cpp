...
namespace dumper::stages::script {
    auto dump() -> bool {
        ...
        g_dumper.add_offset("ModuleScript", "Bytecode", bytecode_ptr_offset, "", FieldType::Pointer);
        g_dumper.add_offset("ByteCode", "Size", size_offset);
        g_dumper.add_offset("ByteCode", "Pointer", 0x10, "", FieldType::Pointer);
        ...
        g_dumper.add_offset("LocalScript", "Bytecode", local_bytecode->first, "", FieldType::Pointer);
        ...
        g_dumper.add_offset("ModuleScript", "Hash", module_hash->first, "", FieldType::Pointer);
        ...
        g_dumper.add_offset("LocalScript", "Hash", local_hash->first, "", FieldType::Pointer);
