...
namespace dumper::stages::tool {
    ...
    auto dump() -> bool {
        ...
        dumper::g_dumper.add_offset("Tool", "CanBeDropped", *can_be_dropped_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("Tool", "Enabled", *enabled_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("Tool", "ManualActivationOnly", *manual_activation_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("Tool", "RequiresHandle", *requires_handle_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("Tool", "Grip", *grip_pos_offset - 0x24, "", FieldType::CFrame);
