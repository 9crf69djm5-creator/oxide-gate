...
namespace dumper::stages::proximity_prompt {
    ...
    auto dump() -> bool {
        ...
        dumper::g_dumper.add_offset("ProximityPrompt", "Enabled", *enabled_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("ProximityPrompt", "RequiresLineOfSight", *requires_los_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("ProximityPrompt", "HoldDuration", *hold_duration_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("ProximityPrompt", "KeyboardKeyCode", *keyboard_key_offset, "", FieldType::UInt32);
        ...
        dumper::g_dumper.add_offset("ProximityPrompt", "MaxActivationDistance",
                                    *max_activation_offset, "", FieldType::Float);
...
REGISTER_STAGE(proximity_prompt)
