...
namespace dumper::stages::text_label {
    ...
    auto dump() -> bool {
        ...
        //     text_label_addrs, [&](size_t i) { return (*text_labels)[i].props.font; }, 0x1000,
        //     0x1);
        // if (!font_offset) {
        //     spdlog::error("Failed to find Font offset");
        //     return false;
        // }
        // dumper::g_dumper.add_offset("TextLabel", "Font", *font_offset, "", FieldType::UInt8);
